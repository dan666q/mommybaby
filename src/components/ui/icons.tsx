...
export const Icons = {
  remove_circle_outline: (props: LucideProps) => (
  ...
  more_horizontal: (props: LucideProps) => (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  report_problem: (props: LucideProps) => (
    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
