...
export default function ProductManager() {
    return (_jsxs(_Fragment, { children: [_jsx(SectionHeader, { title: "Product List", className: "" }), _jsxs("div", { className: "flex flex-col gap-4 p-4", children: [_jsxs("div", { className: "flex justify-between", children: [_jsx(SearchBar, {}), _jsx("div", { className: "flex flex-col gap-4 ml-auto", children: _jsx("div", { className: "flex items-center gap-2", children: _jsx(ConfigAntdTheme, { theme: GreenButtonStyle, children: _jsx(Popup, { width: 700, type: "form", title: POPUP_TITLE.ADD_PRODUCT, content: _jsx(AddProduct, {}), children: _jsx(Button, { type: "primary", icon: _jsx(PlusCircleOutlined, {}), children: "Add new" }) }) }) }) })] }), _jsx(ViewListProduct, {})] })] }));
}
